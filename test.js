...
console.log(!!'false' == !!'true'); // Результат: true. Оператор ! приводить до буля, строка 'false' є трушною, строка 'true' також є трушною, отже true = true

console.log(0 || '0' && 1); // Результат: 1. Число 0 або строка 0 виведе перше true - число 0. Далі 0 && 1 виведе 1, бо оператор &&  виведе останній операнд, якщо немає жодного faalse 
...
console.log((+null == false) < 1 ** 5); // Результат: false. Null перетворюється у false, false = false і це true. True приймає значення 1, а отже 1 < 1 і це false
